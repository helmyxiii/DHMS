...
<head>
    ...
    <title>Create Appointment - Dermatologist - Zawar</title>
...
<body class="bg-dashboard">
    ...
    <header class="text-center text-white py-5">
        <div class="container">
            <h1 class="fw-bold">Create a New Dermatologist Appointment</h1>
            <p class="lead">Fill in the details below to schedule your appointment with a Dermatologist.</p>
        </div>
    </header>
                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <form method="POST" action="{{ route('appointments.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="doctor_name" name="doctor_name" value="Dermatologist" readonly>
                            <input type="hidden" name="doctor_name" value="Dermatologist">
                        </div>
                        <div class="mb-3">
