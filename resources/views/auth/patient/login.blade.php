...
@section('title', 'Patient Sign In - Zawar')
...
<div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="sign-form">
        ...
        @endif
        <form method="POST" action="{{ route('patient.login') }}" class="needs-validation" novalidate>
            @csrf
            <div class="mb-3">
            ...
            <p class="text-center mt-3">
                ...
                <a href="{{ route('patient.register') }}" class="text-decoration-none">Sign Up</a>
            </p>
        </form>
    </div>
</div>
