@extends('layouts.app')
@section('title', 'Select Dentist')

@section('content')
<!-- Header -->
<header class="text-center text-white py-5">
    <div class="container">
        <h1 class="fw-bold">Find a Dentist</h1>
        <p class="lead">Choose from our trusted dental specialists and book your appointment easily.</p>
    </div>
</header>
            ...
            <div class="col-md-4 mb-4">
                <div class="card-custom animate h-100">
                    <div class="card-body text-white">
                        ...
                        <p class="card-text">{{ $doctor->bio ?? 'Experienced Dentist' }}</p>
        ...
        @empty
            <div class="col-12">
                <div class="card-custom animate text-center p-4">
                    <h5 class="text-white">No dentists found at this time.</h5>
                </div>
            </div>
        @endforelse
    </div>
