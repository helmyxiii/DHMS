            ...
            <div class="col-md-4 mb-4">
                <div class="card-custom animate h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-primary mt-2">Go to User Management</a>
                    </div>
                </div>
            </div>
            <!-- View Reports -->
            <div class="col-md-4 mb-4">
                <div class="card-custom animate h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.reports')); ?>" class="btn btn-success mt-2">Go to Reports</a>
                    </div>
                </div>
            </div>
            <!-- Configure Settings -->
            <div class="col-md-4 mb-4">
                <div class="card-custom animate h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.settings')); ?>" class="btn btn-info mt-2">Go to Settings</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card-custom animate h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.doctors')); ?>" class="btn btn-warning mt-2">Go to Doctor Management</a>
                    </div>
                </div>
            </div>
            <!-- Announcements -->
            <div class="col-md-6 mb-4">
                <div class="card-custom animate h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.announcements')); ?>" class="btn btn-danger mt-2">Go to Announcements</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\dhms\resources\views/admin/features.blade.php ENDPATH**/ ?>