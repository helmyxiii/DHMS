...
<head>
    ...
    <title>Select <?php echo e(ucfirst($specialty)); ?> - Zawar</title>
...
<header class="text-center text-white py-5">
    <div class="container">
        <h1 class="fw-bold">Find a <?php echo e(ucfirst($specialty)); ?></h1>
        <p class="lead">Choose from our trusted <?php echo e($specialty); ?>s and book your appointment easily.</p>
    </div>
</header>
                    ...
                    <div class="card-body text-white">
                        ...
                        <div class="mb-2">
                            <span class="badge bg-warning text-dark">
                                ★ <?php echo e($rating); ?> / 5.0
                            </span>
                        </div>
                        <h5 class="card-title text-white"><?php echo e($doctor->name); ?></h5>
                        <p class="card-text"><?php echo e($doctor->bio ?? 'Experienced ' . ucfirst($specialty)); ?></p>
                        <a href="<?php echo e(route('appointments.createForDoctor', $doctor->id)); ?>" class="btn btn-primary mt-2">Book Appointment</a>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-12">
                <div class="card-custom animate text-center p-4">
                    <h5 class="text-white">No <?php echo e($specialty); ?>s found at this time.</h5>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
</html> <?php /**PATH C:\xampp\htdocs\dhms\resources\views/appointments/select_doctor.blade.php ENDPATH**/ ?>