                        ...
                        <div class="col-12">
                            <div class="card-custom animate text-center">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo e(route('admin.features')); ?>" class="btn btn-info text-white">Go to Admin Features</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card-custom animate text-center">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo e(route('doctor.features')); ?>" class="btn btn-info text-white">Go to Doctor Features</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-custom animate mb-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                        <?php if(isset($recentMedicalRecords) && count($recentMedicalRecords)): ?>
                                            ...
                                            <tr>
                                                <td><?php echo e($record->date ? $record->date->format('Y-m-d') : 'N/A'); ?></td>
                                                <td><?php echo e($record->doctor->name ?? 'Unknown'); ?></td>
                                                <td><?php echo e($record->diagnosis); ?></td>
                                                <td><?php echo e($record->treatment); ?></td>
                                                <td>
                                                    <?php
                                                    ...
                                                    <?php if(!empty($prescriptions) && is_array($prescriptions)): ?>
                                                        <ul class="mb-0 ps-3">
                                                            <?php $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    <?php echo e($prescription->medicine_name ?? ''); ?>

                                                                    <?php if(!empty($prescription->dosage)): ?>, <?php echo e($prescription->dosage); ?><?php endif; ?>
                                                                    <?php if(!empty($prescription->frequency)): ?>, <?php echo e($prescription->frequency); ?><?php endif; ?>
                                                                    <?php if(!empty($prescription->duration)): ?>, <?php echo e($prescription->duration); ?><?php endif; ?>
                                                                </li>
                                                ...
                                                <td><a href="<?php echo e(route('patient.medical-records.show', $record->id)); ?>" class="btn btn-sm btn-primary">View</a></td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <tr>
                                                ...
                                                <td>Amoxicillin</td>
                                                <td><a href="<?php echo e(route('patient.medical-records.show', 1)); ?>" class="btn btn-sm btn-primary">View</a></td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                    ...
                    <div class="card-custom animate mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-custom">
                                ...
                                <tbody>
                                    <?php if(isset($upcomingAppointments) && count($upcomingAppointments)): ?>
                                        ...
                                        <tr>
                                            <td><?php echo e($appointment->appointment_date ? $appointment->appointment_date->format('Y-m-d') : 'N/A'); ?></td>
                                            <td><?php echo e($appointment->doctor->name ?? 'Unknown'); ?></td>
                                            <td><span class="badge bg-<?php echo e($appointment->status === 'cancelled' ? 'danger' : 'success'); ?>"><?php echo e(ucfirst($appointment->status)); ?></span></td>
                                            <td>
                                                <a href="<?php echo e(route('appointments.show', $appointment->id)); ?>" class="btn btn-sm btn-primary">View</a>
                                                <a href="<?php echo e(route('patient.appointments.request-change.form', ['appointment' => $appointment->id])); ?>" class="btn btn-sm btn-info">Request Change</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('appointments.show', 1)); ?>" class="btn btn-sm btn-primary">View</a>
                                                <a href="<?php echo e(route('patient.appointments.request-change.form', ['appointment' => 1])); ?>" class="btn btn-sm btn-info">Request Change</a>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                                            ...
                                            <div class="col-md-3">
                                                <div class="card-custom">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <button class="btn btn-primary mt-2" onclick="window.location.href='<?php echo e(route('appointments.selectDoctor', ['specialty' => 'dentist'])); ?>'">Choose Doctor</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="card-custom">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <button class="btn btn-success mt-2" onclick="window.location.href='<?php echo e(route('appointments.selectDoctor', ['specialty' => 'dermatologist'])); ?>'">Choose Doctor</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="card-custom">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <button class="btn btn-danger mt-2" onclick="window.location.href='<?php echo e(route('appointments.selectDoctor', ['specialty' => 'cardiologist'])); ?>'">Choose Doctor</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="card-custom">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <button class="btn btn-info mt-2" onclick="window.location.href='<?php echo e(route('appointments.selectDoctor', ['specialty' => 'gp'])); ?>'">Choose Doctor</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <ul class="list-group">
                                <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        ...
                                        <div><?php echo e($announcement->message); ?></div>
                                        <small class="text-muted"><?php echo e($announcement->created_at->format('Y-m-d H:i')); ?></small>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\dhms\resources\views/dashboard.blade.php ENDPATH**/ ?>