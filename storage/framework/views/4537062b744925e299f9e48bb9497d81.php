...
<body class="bg-dashboard">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if(auth()->check() && auth()->user()->isDoctor()): ?>
    ...
    <div class="container my-4">
        <form method="GET" action="<?php echo e(route('doctor.medical-records.index')); ?>" class="row g-3 justify-content-center">
            <div class="col-auto">
                <input type="number" name="patient_id" class="form-control" placeholder="Search by Patient ID" value="<?php echo e(request('patient_id')); ?>">
            </div>
            <div class="col-auto">
...
<?php /**PATH C:\xampp\htdocs\dhms\resources\views/medical-records/index.blade.php ENDPATH**/ ?>