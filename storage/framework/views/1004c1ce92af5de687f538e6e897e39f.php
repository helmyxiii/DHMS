...
<?php $__env->startSection('title', 'Announcements - Zawar'); ?>
...
<div class="container py-5 dashboard-bg">
    ...
    <div class="card card-custom animate mb-4">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.announcements.send')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dhms\resources\views/admin/announcements.blade.php ENDPATH**/ ?>