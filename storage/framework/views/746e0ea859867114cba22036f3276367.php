...
<body class="bg-dashboard">
    ...
    <header class="text-center text-white py-5">
        <div class="container">
            <?php $isDoctor = auth()->check() && auth()->user()->hasRole('doctor'); ?>
            <?php if($isDoctor): ?>
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-<?php echo e($appointment->status === 'cancelled' ? 'danger' : 'success'); ?>">
                                                            <?php echo e(ucfirst($appointment->status)); ?>

                                                        </span>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo e(route('doctor.appointments.show', $appointment)); ?>" class="btn btn-sm btn-info">View</a>
                                                        <a href="<?php echo e(route('doctor.appointments.edit', $appointment)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                                        <form action="<?php echo e(route('doctor.appointments.destroy', $appointment)); ?>" method="POST" class="d-inline">
                                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\dhms\resources\views/appointments/index.blade.php ENDPATH**/ ?>